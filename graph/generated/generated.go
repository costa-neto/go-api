...
func (ec *executionContext) _Mutation_search(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOResponse2ᚖgithubᚗcomᚋcostaᚑnetoᚋgoᚑapiᚗgitᚋgraphᚋmodelᚐResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOResponse2ᚖgithubᚗcomᚋcostaᚑnetoᚋgoᚑapiᚗgitᚋgraphᚋmodelᚐResponse(ctx context.Context, sel ast.SelectionSet, v *model.Response) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
